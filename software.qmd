...
## {{< iconify mdi language-r >}} [Missing Data Scenarios in RCTs](https://davidloeb-missing-data-app.share.connect.posit.cloud/){target="_blank"}
...
Vist the [{{< iconify mdi language-r >}} app webpage](https://davidloeb-missing-data-app.share.connect.posit.cloud/){target="_blank"} to try it out. You can also view the [source code on {{< iconify fa github >}} GitHub](https://github.com/david-loeb/missing-data-app){target="_blank"}.